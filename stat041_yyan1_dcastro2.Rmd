...
ggplot(college.join, mapping = aes(y = sharewomen*100, x = Major)) + geom_col(color = "lightslateblue", alpha = 0.6) + labs(y = "Major", x = "Share of Women (%)", title = "Share of Women in Each Major") + coord_flip() +
        theme(axis.text.x = element_text(angle = 0, vjust = 1 , hjust = 1), 
