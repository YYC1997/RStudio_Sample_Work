...
ggplot(college.join, mapping = aes(x = sharewomen*100, y = Major)) + geom_point(color = "purple") + labs(y = "Major", x = "Share of Women (%)", title = "Share of Women in Each Major") + theme(axis.text.x = element_text(angle = 0, vjust = 1 , hjust = 1), 
        axis.line.x = element_line(colour = "black"), 
        axis.title = element_text(size = 12), 
        axis.text = element_text(size = 12), 
        title = element_text(size = 15, color = "aquamarine3"),
        axis.title.x = element_text(size = 12, colour = "darkviolet"),
        axis.title.y = element_text(size = 12, colour = "goldenrod3")
