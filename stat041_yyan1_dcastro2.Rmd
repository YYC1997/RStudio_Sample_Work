...
ggplot(college.join, mapping = aes(x = sharewomen*100, y = Major)) + geom_point() + labs(y = "Major", x = "Share of Women (%)", title = "Share of Women in Each Major") + theme(axis.text.x = element_text(angle = 0, vjust = 1 , hjust = 1), 
